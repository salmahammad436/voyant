import type { WebsiteScoreCardProps } from "../../interfaces/anaResult";
		...
		<div className="border border-gray-200 p-5 rounded-lg hover:shadow-md transition-shadow">
			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-3">
				<div className="bg-gray-50 p-3 rounded-lg text-center">
					...
					<p
						className={`text-xl font-bold ${getColorClass(data.performanceScore)}`}
					>
				...
				<div className="bg-gray-50 p-3 rounded-lg text-center">
					...
					<p
						className={`text-xl font-bold ${getColorClass(data.accessibilityScore)}`}
					>
				...
				<div className="bg-gray-50 p-3 rounded-lg text-center">
					...
					<p
						className={`text-xl font-bold ${getColorClass(data.bestPracticeScore)}`}
					>
